...
<body>
    ...
    <div class="photos">
        <div class="rubrika">
            <img src="foto38.png" alt="foto38">
            <h2>Romane</h2>
            <p>Cmimi - 12.00$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto35.png" alt="foto35">
            <h2>Romane</h2>
            <p>Cmimi - 4.80$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto36.png" alt="foto36">
            <h2>Romane</h2>
            <p>Cmimi - 5.00$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto37.png" alt="foto37" style="height:295px">
            <h2>Romane</h2>
            <p>Cmimi - 10.00$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto31.png" alt="foto31" style="width: 198;">
            <h2>Romane</h2>
            <p>Cmimi - 12.50$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto32.png" alt="foto32" style="width: 198px;">
            <h2>Romane</h2>
            <p>Cmimi - 8.50$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto33.png" alt="foto33" style="width: 198px; height:280px ;">
            <h2>Romane</h2>
            <p>Cmimi - 9.00$</p>
            <button>Shto në shportë</button>
        ...
        <div class="rubrika">
            <img src="foto34.png" alt="foto34" style="width: 198px; height:280px">
            <h2>Romane</h2>
            <p>Cmimi - 12.00$</p>
            <button>Shto në shportë</button>
        ...
        <div class="rubrika">
            <img src="foto40.png" alt="foto40" style="width: 198;">
            <h2>Romane</h2>
            <p>Cmimi - 15.00$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto41.png" alt="foto41">
            <h2>Romane</h2>
            <p>Cmimi - 28.00$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto42.png" alt="foto42" style="width: 200px; height: 290px;">
            <h2>Romane</h2>
            <p>Cmimi - 33.00$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto43.png" alt="foto43">
            <h2>Romane</h2>
            <p>Cmimi - 40.00$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto44.png" alt="foto44" style="width: 200px; height:290px">
            <h2>Romane</h2>
            <p>Cmimi - 6.90$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto45.png" alt="foto45" style="width: 200px; height:290px">
            <h2>Romane</h2>
            <p>Cmimi - 9.80$</p>
            <button>Shto në shportë</button>
        </div>
        <div class="rubrika">
            <img src="foto46.png" alt="foto46" style="width: 200px; height:290px">
            <h2>Romane</h2>
            <p>Cmimi - 5.00$</p>
            <button>Shto në shportë</button>
        </div>
        ...
        <div class="rubrika">
            <img src="foto47.png" alt="foto47" style="width: 200px; height:290px">
            <h2>Romane</h2>
            <p>Cmimi - 10.00$</p>
            <button>Shto në shportë</button>
        </div>
